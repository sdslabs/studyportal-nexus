...
router.register(
    r'users', views.UserViewSet, base_name='users'
)
router.register(
    r'filerequests', views.FileRequestViewSet, base_name='filerequests'
)
router.register(
    r'^courserequests', views.CourseRequestViewSet, base_name='courserequests'
)
router.register(
    r'uploads', views.UploadViewSet, base_name='uploads'
)
